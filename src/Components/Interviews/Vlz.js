    ...
    <>
      ...
      <AnimateHeight height={height} duration={700}>
        <div className={styles.interview} easing="ease-in-out">
          ...
          <p className={styles.q}>
            — Ранее вы говорили, что ведете переговоры с «Росатомом» о закупке отливок Выксунского литейного завода вместо испанских. Чем они завершились?
          </p>

          <p className={styles.a}>
            — Нам удалось договориться, и сейчас мы адаптируем и корректируем европейские технологии и стандарты под наши. После того, как эта работа будет закончена, мы сможем не только поставлять отливки «Росатому», но и предлагать их на европейском рынке. Также мы начали сотрудничество с Муромским машиностроительным заводом. Предприятие выполняет крупный государственный заказ по созданию оборудования для новой обсерватории в Бурятии, и наши отливки будут в составе установленного на этом объекте оборудования.
          </p>
          ...
          <p className={styles.a}>
            — Мы договорились о сотрудничестве с Белорусским автомобильным заводом («БелАЗ»). Поставлена опытная партия отливок, которая успешно прошла входной контроль и допущена к использованию. Сейчас эти детали находятся в сборочном цеху и ждут установки на грузовики «БелАЗа». После этого начнется опытная эксплуатация. В итоге мы получим окончательную резолюцию о возможности использования нашей продукции на этом предприятии.
          </p>
