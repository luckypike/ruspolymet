      ...
      <AnimateHeight height={height} duration={700}>
        <div className={styles.interview} easing="ease-in-out">
          <p className={styles.vstup}>
            Как из завода, основанного в XIX веке, сделать современное предприятие-экспортер, рассказывает генеральный директор металлургического металлообрабатывающего предприятия ПАО «Русполимет» Максим Клочай.
          </p>
          ...
          <p className={styles.a}>
            — По контракту с «Росатомом» мы работаем для проектов, которые компания реализует в России и за рубежом. Сейчас активно строится первая в Турции АЭС «Аккую». Для этого проекта мы поставляли кольцевые заготовки и задвижки. Также «Русполимет» поставляет широкий ассортимент продукции всем предприятиям «Атомэнергомаша» — машиностроительного дивизиона госкорпорации «Росатом».
          </p>
          ...
          <p className={styles.a}>
            — Пока мы поставили цель на зарубежных рынках расширить сотрудничество с авиационными предприятиями. Это наши постоянные заказчики, например Pratt&Whitney. Мы уже достаточно давно с ними сотрудничаем и планируем увеличить объемы экспортных поставок на европейском рынке, например, с одной из французских компаний договор уже находится в стадии согласования. Также в качестве партнеров рассматривается ряд корейских компаний. Восток вообще очень перспективное направление, но все сразу не охватить.
          </p>
          ...
          <p className={styles.a}>
            — Да, уже десять месяцев мы используем систему SAP — это программный комплекс для управления предприятиями от материальных потоков до производства. На старте были определенные сложности, почти все службы работали в круглосуточном режиме, появились проблемы и подводные камни, о которых мы не догадывались. На протяжении всего года мы постепенно решали множество задач, и настройка системы все еще продолжается. Пока мы установили модули по управлению производством, продажами, бюджетом, финансовыми потоками; учет, отчетность, аналитика, контроллинг также теперь в единой системе управления всеми бизнес-процессами предприятия. Работа в данном направлении продолжится еще два года: мы планируем внедрить в систему модули по управлению персоналом, техническим обслуживанием и ремонтом оборудования, взаимоотношениями с клиентами. Именно тогда и можно будет максимально точно оценить эффект от внедрения SAP. Пока же можно говорить только о первых изменениях. Кроме того, мы внедрили систему электронного документооборота, которая позволила нам оцифровать процесс согласования договоров, приказов, другой документации. Благодаря внедрению электронного документооборота заметно сократились сроки прохождения документов, процесс стал прозрачнее.
          </p>

          <p className={styles.q}>
            — На отраслевой выставке «Металл-Экспо» было подписано соглашение между «Русполиметом» и ФГКП «Центральный научно-исследовательский институт черной металлургии им. И.П. Бардина». В чем суть этого документа?
          </p>

          <p className={styles.a}>
            — В рамках заключенного соглашения стороны намерены создать единый научный центр и совместно заниматься инновационными разработками в сфере металлургии. Для этого будет использоваться имеющаяся у института научная база и наработки «Русполимета», которые тоже достаточно обширны. «Русполимет» готов стать промышленной площадкой, на которой будут не только создаваться и испытываться новые виды сплавов, в том числе порошковые, и изделий из них, но и в дальнейшем может быть налажено их промышленное производство. Это дает компании определенное преимущество: после того, как новый продукт будет создан, во всей технической документации на него, во всех ТУ будет указано, что это продукция проверенного производителя. Это даст определенные конкурентные преимущества.
          </p>
